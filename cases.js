...
{id:'c1', n:1,
 arrival:'An approximately 68-year-old woman is brought in by EMS from a restaurant after suddenly stopping mid-meal, becoming unable to speak, developing persistent leftward gaze, and no longer moving the right arm or leg. She has no identification, and no family is initially available.',
 activation:'Acute language change and right-sided weakness',
 context:'Identity, baseline function, medications, and prior medical history are not yet available.',
...
{id:'c2', n:2,
 arrival:'A 74-year-old woman is found by family on the bedroom floor at 6:30 AM. She is mute, does not appear to attend to the right side of visual space, and is not moving the right arm or leg. Family last saw her normal at 10 PM the night before.',
 activation:'Wake-up focal neurologic deficit',
 context:'Family is available for collateral. Last known well was 10 PM the night before presentation.',
...
{id:'c3', n:3,
 arrival:'An adult woman is brought in by EMS after collapsing at a bus stop. She is not speaking and is not moving the right arm or leg. She has no identification or phone, and no family is immediately available. A bystander saw the collapse but cannot establish the exact onset.',
 activation:'Acute aphasia and right-sided weakness with unclear onset',
 context:'Baseline function, medical history, medications, and last known well are initially unknown.',
...
{id:'c4', n:4,
 arrival:'A 61-year-old woman is found by family at 7 PM with left facial, arm, and leg weakness. Her eyes are persistently deviated to the right and she does not attend to the left side. She was last known normal at 8 AM that morning.',
 activation:'Left-sided weakness and neglect',
 context:'Family provides the timeline; last known well was approximately 11 hours before discovery.',
...
{id:'c5', n:5,
 arrival:'A 58-year-old man develops abrupt somnolence at home about two hours before arrival. Family notices left ptosis, an enlarged left pupil, the left eye resting down and out, slurred speech, and weakness of the right arm and leg.',
 activation:'Somnolence, ocular findings, and right-sided weakness',
 context:'Family witnessed the onset and is available for collateral; the symptoms began abruptly approximately two hours before evaluation.',
...
{id:'c6', n:6,
 arrival:'A 62-year-old man presents about 90 minutes after the sudden onset of continuous severe vertigo with repeated vomiting. He cannot sit upright without support and his speech sounds slurred. No obvious unilateral limb weakness is reported.',
 activation:'Acute vertigo with inability to sit unsupported',
 context:'Symptoms have been continuous since onset rather than brief or episodic.',
...
{id:'c7', n:7,
 arrival:'A 43-year-old right-handed dentist notices abrupt loss of right-hand function about 90 minutes before evaluation. He cannot make a fist or rapidly tap his fingers. He reports no facial, speech, or leg symptoms.',
 activation:'Isolated right-hand weakness',
 context:'He is independent at baseline, and fine hand function is important to his occupation.',
...
{id:'c8', n:8,
 arrival:'A 72-year-old man develops sudden loss of speech, persistent leftward gaze, and weakness of the right arm and leg about two hours before arrival. EMS repeatedly records blood pressures around 212/118.',
 activation:'Acute aphasia and right hemiparesis with severe hypertension',
 context:'Severe hypertension is confirmed repeatedly in the field; other treatment-relevant history is obtained during the acute evaluation.',
...
{id:'c9', n:9,
 arrival:'A 66-year-old man presents after the sudden onset of a severe headache about 90 minutes before arrival, followed by vomiting and weakness of the left arm and leg. EMS records blood pressures around 198/108.',
 activation:'Acute headache, vomiting, and left-sided weakness',
 context:'History is limited on initial evaluation; baseline function and medication history have not yet been established.',
...
{id:'c10', n:10,
 arrival:'A 67-year-old man becomes unresponsive during dinner, with forced head version to the right and rhythmic jerking of the right face and arm for about one minute. After the event he remains confused and tachypneic. EMS finds him sleepy, dysarthric, and weak in the right arm.',
 activation:'Seizure-like activity followed by weakness and confusion',
 context:'History includes hypertension, diabetes, tobacco exposure, and prior TIA. The event was witnessed.',
...
{id:'c11', n:11,
 arrival:'A 56-year-old man is in the ICU after massive hemoptysis requiring bronchial artery embolization, intubation, shock, and neuromuscular blockade. After the paralytic has cleared and he begins to awaken, he reliably follows commands with both arms but initially has no voluntary movement of either leg.',
 activation:'New bilateral lower-extremity weakness after critical illness',
 context:'Relevant history includes pulmonary sarcoidosis, a presumed right upper-lobe aspergilloma, recent shock/hypotension, and several weeks of burning or numb feet and gait difficulty before this admission. Brain MRI already shows small multifocal acute infarcts, and thoracic MRI shows an abnormal cord signal of uncertain age.',
...
{id:'c12', n:12,
 arrival:'A 79-year-old hospitalized woman develops fluctuating confusion on hospital day 4. Nursing reports that she was sleepy and inattentive in the morning, more conversational around noon, and confused again later in the afternoon. At the time of neurology evaluation she is awake and conversational but easily loses the thread of conversation.',
 activation:'Fluctuating confusion and decreased responsiveness',
 context:'She has substantial cerebrovascular disease and chronic small-vessel ischemic change, prolonged hospitalization for systemic illness, poor sleep, pain, reduced mobility, renal dysfunction, anemia, and several medication changes. Family reports cognitive independence before admission but says she becomes confused easily when ill.',
...
,
{id:'c13', n:13,
 arrival:'A 62-year-old woman presents with several days of worsening fatigue and intermittent dysarthria. Family reports that her speech is usually normal in the morning but becomes harder to understand after prolonged conversation and near the end of meals.',
 activation:'Progressive fatigue and intermittent dysarthria',
 context:'She is independent at baseline and has no known neuromuscular diagnosis or recent stroke history. She mainly describes the problem as "fatigue," while family has noticed worsening speech and chewing later in the day.',
...
{id:'c14', n:14,
 arrival:'A 65-year-old man with metastatic lung cancer and known brain metastases becomes progressively less interactive over several hours. He is intermittently mute and inconsistently follows commands. No generalized convulsion has been witnessed.',
 activation:'Increasing confusion and reduced responsiveness in a patient with brain metastases',
 context:'Recent imaging shows multiple supratentorial metastases with substantial surrounding vasogenic edema. He has also received several medications that could affect alertness. Nursing has noticed brief staring episodes and inconsistent command following.',
...
const CASE_DESIGN = {
  ...
  c11:{
    ...
    actionPurpose:{
      focused_exam:'For bilateral leg weakness, deliberately re-check strength distribution, reflexes, pinprick, vibration, proprioception, sensory level, and sacral findings to discriminate among cord, conus/roots, peripheral nerve, and multifocal disease.',
